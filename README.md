...
4. Build the applicaton (blinkytest, or sensortest, etc.), with your selected board from that applications "boards" folder i.e. `west build blinkytest -b ubcrocket_fc_2526_r1 -p`
5. Connect the board to your computer and flash it: `west flash`
6. For a better developer experience, use VS Code with the 'Zephyr IDE Extension Pack' extension
